...
import { finalBookData, handleStep, schedulerSliceSelector } from "@/redux/scheduler";
...
const paymentDetail = () => {
  ...
  const { schedulerResponse, schedulerData, saveBookInfo, bookAppointmentInfo } = useSelector(schedulerSliceSelector);
  ...
  const PaymentForm = () => {
    ...
    return (
      <>
        ...
        />
        <Button isBorderBtn={true} onClick={e => goBack(e)}>GO BACK</Button>
      </>
    );
  };
        ...
        <Form>
          <Elements stripe={stripePromise}>
            ...
            <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
              ...
              <Input type="type" placeholder="Will Smith" id="accHolderName" value={username} onChange={(e) => handlechangeCardname(e)} />
            ...
            <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
              ...
              <CardCvcElement
                ...
                className="" onChange={(e) => handlechangeCardcsv(e)}
              />
              {cvcError && <p className="text-danger">{cvcError}</p>}
            </FormGroup>
            <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
              <Label>{t('receiptConfirmation')} <span>({t('optional')})</span></Label>
              <Input type="email" placeholder="abc@gmail.com" value={email} onChange={(e) => handleEmailChange(e)} />
            </FormGroup>
            <PaymentForm />
          </Elements>
        </Form>
