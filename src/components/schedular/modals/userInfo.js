...
const userInfo = () => {
  ...
  const { schedulerResponse, schedulerData } = useSelector(schedulerSliceSelector);
  ...
  const formSchema = yup.object().shape({
    guest: yup.number(),
    dob: yup.mixed().required("Birthdate is required"),
    email: yup
      .string()
      ...
      if (!res?.status) {
        switch (guestIndex) {
          case 0:
            ...
            setValue("dob", filledValue?.client_dob || null);
            setDate(filledValue?.client_dob || "");
            break;
          case 1:
        ...
        <Form onSubmit={handleSubmit(onSubmitForm)}>
          ...
          <div className="yourself-guest-detail">
              ...
              <PhoneInput
                ...
                onChange={(phone, data, event, formattedValue) => {
                  ...
                  if (data?.dialCode && filedValue.toString().length === 10) {
                    CheckPhone(data?.dialCode, filedValue, 0);
                  }
            ...
            <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
              ...
              />
              <p className="text-danger phone_input">{errors?.name?.message}</p>
            </FormGroup>
            <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
              <Label>{t("email")}</Label>
              <Input
              ...
              />
              <p className="text-danger phone_input">{errors?.email?.message}</p>
            </FormGroup>
            <FormGroup
            ...
            >
              ...
              <p className="text-danger phone_input">{errors?.dob?.message}</p>
            </FormGroup>
            <FormGroup className="formBasicEmail">
              ...
              <Input
                ...
                {...register("mainNote")}
              />
              <p className="text-danger">{errors?.mainNote?.message}</p>
            </FormGroup>
          </div>
          {schedulerResponse?.guest > 0 && (
            <div className="yourself-guest-detail">
              ...
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                ...
                />
                <p className="text-danger phone_input">{errors?.guest1phoneNumber?.message}</p>
              </FormGroup>
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                <Label>{t("name")}</Label>
                <Input
                ...
                />
                <p className="text-danger phone_input">{errors?.guest1name?.message}</p>
              </FormGroup>
              <FormGroup
                controlId="formBasicEmail"
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  {...register("noteGuest1")}
                />
                <p className="text-danger">{errors?.noteGuest1?.message}</p>
              </FormGroup>
            </div>
          )}
          {schedulerResponse?.guest > 1 && (
            <div className="yourself-guest-detail">
              ...
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                ...
                />
                <p className="text-danger phone_input">{errors?.guest2phoneNumber?.message}</p>
              </FormGroup>
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                <Label>{t("name")}</Label>
                <Input
                ...
                />
                <p className="text-danger phone_input">{errors?.guest2name?.message}</p>
              </FormGroup>
              <FormGroup
                controlId="formBasicEmail"
                className="marging-bottom-wrapper show-calendar"
              ...
              <FormGroup className="formBasicEmail">
                ...
                <Input
                  ...
                  {...register("noteGuest2")}
                />
                <p className="text-danger">{errors?.noteGuest2?.message}</p>
              </FormGroup>
            </div>
          )}
          {schedulerResponse?.guest > 2 && (
            <div className="yourself-guest-detail">
              ...
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                ...
                />
                <p className="text-danger phone_input">{errors?.guest3phoneNumber?.message}</p>
              </FormGroup>
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                <Label>{t("name")}</Label>
                <Input
                ...
                />
                <p className="text-danger phone_input">{errors?.guest3name?.message}</p>
              </FormGroup>
              <FormGroup
                controlId="formBasicEmail"
                className="marging-bottom-wrapper show-calendar"
              ...
              <FormGroup className="formBasicEmail">
                ...
                <Input
                  ...
                  {...register("noteGuest3")}
                />
                <p className="text-danger">{errors?.noteGuest3?.message}</p>
              </FormGroup>
            </div>
          )}
          {schedulerResponse?.guest > 3 && (
            <div className="yourself-guest-detail">
              ...
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                ...
                />
                <p className="text-danger phone_input">{errors?.guest4phoneNumber?.message}</p>
              </FormGroup>
              <FormGroup controlId="formBasicEmail" className="marging-bottom-wrapper">
                <Label>{t("name")}</Label>
                <Input
                ...
                />
                <p className="text-danger phone_input">{errors?.guest4name?.message}</p>
              </FormGroup>
              <FormGroup
                controlId="formBasicEmail"
                className="marging-bottom-wrapper show-calendar"
              ...
              <FormGroup className="formBasicEmail">
                ...
                <Input
                  ...
                  {...register("noteGuest4")}
                />
                <p className="text-danger">{errors?.noteGuest4?.message}</p>
              </FormGroup>
            </div>
          )}
          <FormGroup controlId="formBasicEmail">
            ...
            <p className="text-danger">{errors?.listInfo?.message}</p>
          </FormGroup>
          <LoadingButton
            type="submit"
            disabled={loading}
          ...
          />
          <Button type="reset" isBorderBtn={true} onClick={() => goBack()}>
            {t("goBack")}
          </Button>
        </Form>
      </SchedulerModalLayoutWrapper>
