...
import { handleBank } from "@/redux/messageTab";
...
const AddCardDetailModal = ({ lgCardShow, setLgCardShow, selectedPlan,getSubscriptionForSpotLight }) => {
  //hooks
     ...
     try {
        setIsPaymentProgress(true);
          let subscriptionData = {
            ...
            type: selectedPlan?.plan_name,
          };
          const subscriptionRes = await axiosApiCall.post(
            API_ROUTER?.ADD_SPA_CARD_SPOTLIGHT,
            subscriptionData
          );
