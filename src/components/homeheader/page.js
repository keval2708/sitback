...
export default function HomeHeader() {
  ...
  const handleShow = () => dispatch(handleHideBlog(true));
    ...
    <BlogHeaderWrapper className={`home-page-headerwrapper home-page-updated-header-wrapper ${isVisible ? 'sitback-mobile-menu-header-wrapper' : ''}`}>
      {/* <Navbar expand="md" >
        <Container className="home-page-header-container-wrapper">
          <div>
            <Navbar.Brand href="/" className="sitback-logo-wrapper sitback-home-logo-header-wrapper">
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            <div className="logout-and-profile">
              {showHeader ? (
                ...
                <Button className="font-weight-seven-hundred" onClick={() => handleRedirect()}>For Businesses</Button>
              )}
            </div>
          </Navbar.Collapse>
        </Container>
        ...
        <Container className="home-page-header-container-wrapper">
          <div className="sitback-header-inner-div">
            ...
            <div className="header-login-btn">
              <Button className="business-btn" onClick={() => handleRedirect()}>{t('forBusiness')}</Button>
              ...
              <div className="header-mobile-menu-div">
                <div className="header-mobile-menu-inner-div">
                  ...
                  <div className="header-mobile-btn-div">
                    <Button className="for-business-btn" onClick={() => handleRedirect()}>{t('forBusiness')}</Button>
                  </div>
                </div>
              </div>
            )}
