...
const params = useParams();
  ...
  useEffect(() => {
    ...
    if (homeSelectedService) {
      chips.push({
        key: 'service',
        label: homeSelectedService.label,
        onClear: () => {
  ...
  const fetchMyCurrentReviewList = async () => {
      try {
          ...
          if(selectedCityOption) {
            ...
            param.cityslug = params?.location;
          }
  ...
  const fetchSpaData = async (isClare = null) => {
    try {
      ...
      if(selectedServiceData) {
        ...
        param.serviceid = params?.service;
      }
      ...
      const res = await axiosApiCall.post(API_ROUTER?.GET_ALL_SPA_LIST_SERVICES_SLUG, param);
      if (!res?.status) {
        return toaster(res?.message, TOAST_TYPES.ERROR);
      } else {
    ...
    <>
              ...
              <div className="banner-content-wrapper spa-page-banner-content-div">
                <div className="banner-top-title-div">
                  <Container>
                    ...
                    <p className="breadcrumb-text bread-crumb-spa-text">Home <span className="sign-text">&gt;</span> Services</p>
                  </Container>
                </div>
              </div>
            </div>
              ...
              <Accordion.Item eventKey="0">
                  <div className="accordion-title-content">
                    ...
                    <div className="accordion-right-content">
                       {totalSpasAvailable > 1 ? <p>{totalSpasAvailable} Spas Available</p> : <p>{totalSpasAvailable} Spa Available</p>}
                    </div>
          ...
          {/* <div className="mobile-view-filter-wrapper">
            ...
            <a href="javascript:void(0);" className="filter-icon-wrapper" onClick={() => handleShow()}>
              <span className="img-wrapper">
                <Image alt="sitback" src="/images/filter-icon.svg"/>
              </span>
            </a>
          </div> */}
                  ...
                  <Row>
                    ...
                    <Col xs='12' sm='12' lg='6' xl='6' key={index}>
                      <ScottsdaleBoxWrapper className="spas-detailbox spa-updated-detail-box">
                        <div>
                          <div className="imagebox" onClick={() => { push(PATH_AUTH?.spas + "/" + spaData?.slug) }}>
                            ...
                            <div className="rating-mobile-view-display">
                              ...
                              {spaData?.ratings} <span className="review-text">({spaData?.totalReviewCount} Reviews)</span>
                            </div>
                        ...
                        <div className="scottsdale-detail">
                          ...
                          <div className="availble-services-wrapper">
                            ...
                            <div className="mobile-view-services-block">
                              ...
                              <div className="text-center">
                                <Button className="booknow booknow-btn-mobile-view"  onClick={() => handleSelectedService(spaData)}>Book Now</Button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <TopReviewSpasNearComponent
                    ...
                    onSeeAllReviews={() => {
                      if (activeChips.length > 0 && activeChips.some(chip => chip.key === 'city')) {
                        ...
                        dispatch(mySpaLocationPageSelectedCity(params?.location));
                      }
      ...
      >
        <Modal.Header closeButton className="red-close-icon">
          ...
          <div className="filter-btn-div">
            <Button className="apply-filter-btn-wrapper" onClick={() => handleApplyFilters()}>Apply Filter</Button>
          </div>
        </Modal.Header>
        <Modal.Body>
