...
import { Accordion, Col, Container, Form,FormGroup, Row,} from "react-bootstrap";
...
import { myHomePageSelectedCity, myHomePageSelectedDate, myHomePageSelectedService, mySelectedCity, mySelectedDate, mySelectedServiceList, mySelectedSlot, mySpaLocationPageSelectedCity, mySpaPageSelectedCity } from "@/redux/service";
...
export default function ComingSoon() {
 ...
 const {
  ...
  const [loadingFeaturedSpa, setLoadingFeaturedSpa] = useState(false);
  ...
  const getFaqs = async () => {
    ...
    try {
      ...
      if (res?.status && res?.data?.data) {
        ...
        //toaster(res?.message || "Failed to load FAQs", TOAST_TYPES.ERROR);
      }
    } catch (error) {
      toaster("Error loading FAQs", TOAST_TYPES.ERROR);
    } finally {
      setLoadingFaq(false);
    }
  };
  ...
  const handleRadioChangeWithService = (data) => {
    dispatch(mySelectedSlot(null))
    if(data?.subdata) {
       dispatch(mySelectedServiceList(
        {
          value:data?.subdata?.id,
          label:data?.subdata?.name,
          image:data?.subdata?.image,
          price:data?.subdata?.price,
          time: { hour:data?.subdata?.hour, minute:data?.subdata?.minutes },
          calculatedTime: `(${data?.subdata?.hour * 60 +data?.subdata?.minutes} min)`,
        }
      ));
    }
    if(data?.futuredate && data?.futuredate != '') {
  ...
  // console.log("cityInputValue",cityInputValue);
   console.log("featuredSpa",featuredSpa);
  return (
    <>
    <HomeHeader />
        ...
        <section className="sitback-banner-updated-div">
          <div className="sitback-banner-image-div">
            ...
            <div className="banner-content-wrapper">
              <div className="banner-top-title-div banner-landing-top-title-div">
                <Container>
                  <h1>{t('comingSoonText1')}</h1>
                  <p>{t('comingSoonText2')}</p>
                </Container>
              </div>
            </div>
          </div>
          <div className="sitback-filter-main-div sitback-landing-filter-div">
              <Form id="comingSoonText2" className="filter-inputbox-wrapper sitback-landing-filter-desktop-view">
                <FormGroup className="filterbox-input">
                  <Label className="select-city-label-wrapper">
                    <InlineSVG src={CitySelectIcon_icon} className="global_laguage_icon select-city-icon-wrapper" />
                    {t("selectCityText")}
                  </Label>
                ...
                <FormGroup className="filterbox-input datepicker-box">
                  ...
                  {isDayPickerVisible &&
                    reactDom.createPortal(
                      ...
                      <div style={{ position: "absolute", top: position.top, left: position.left, zIndex: 9999}} className="calendarv2-wrapper-div">
                        <DayPicker
                            mode="single"
      ...
      <HowItWorksLandingWrapper>
        <Container>
          <div className="how-it-works-inner-div">
            <div className="how-it-work-header-div">
              <h3>{t('comingSoonHowItsWorkText')}</h3>
              <p>{t('comingSoonBookSpaAppointmentsText')}</p>
            </div>
            <div className="how-it-work-boxes-wrapper">
              <div className="how-it-work-web-view-div">
                <Row>
                  <Col md={6} lg={4}>
                      <div className="how-it-work-box-div">
                          <div className="how-it-work-img-div">
                            <img src="/images/how-it-work-icon-1.svg" alt="Panel 1" />
                          </div>
                          <div className="how-it-work-detail-div">
                              <h4>1. <span>{t('ExploreText')}</span></h4>
                              <p>{t('comingSoonBrowseDescText')}</p>
                          </div>
                      </div>
                  </Col>
                  <Col md={6} lg={4}>
                      <div className="how-it-work-box-div">
                          <div className="how-it-work-img-div">
                            <img src="/images/how-it-work-icon-2.svg" alt="Panel 1" />
                          </div>
                          <div className="how-it-work-detail-div">
                              <h4>2. <span>{t('RequestText')}</span></h4>
                              <p>{t('comingSoonBookDescText')}</p>
                          </div>
                      </div>
                  </Col>
                  <Col md={6} lg={4}>
                      <div className="how-it-work-box-div">
                          <div className="how-it-work-img-div">
                            <img src="/images/how-it-work-icon-3.svg" alt="Panel 1" />
                          </div>
                          <div className="how-it-work-detail-div">
                              <h4>3. <span>{t('relaxText')}</span></h4>
                              <p>{t('comingSoonRelaxDescText')}</p>
                          </div>
                      </div>
                  </Col>
                </Row>
              </div>
              <div className="how-it-work-mobile-view-div">
                <Swiper
                  slidesPerView={1.7}
                  spaceBetween={18}
                  navigation={false}
        ...
        <Container>
          <div className="why-people-choose-inner-div">
            <div className="why-people-choose-header-div">
              <h3>{t('comingSoonWhyPeopleChooseText')}</h3>
              <p>{t('comingSoonWhyPeopleChooseDesc')}</p>
            </div>
            <div className="why-people-box-wrapper">
              <Row>
                <Col md={6}>
                  <div className="why-people-choose-img-div">
                    <img src="/images/why-choose-image.png" alt="Panel 1" />
                  </div>
                </Col>
                <Col md={6}>
                  <div className="why-people-choose-detail-div">
                    <div className="why-people-list-display-wrapper">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonRealTimeAvailabilityText')}</h4>
                        <p>{t('comingSoonRealTimeAvailabilityDesc')}</p>
                      </div>
                    </div>
                    <div className="why-people-list-display-wrapper">
                      <div className="clearfix">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonExclusiveSpaDiscountsText')}</h4>
                        <p>{t('comingSoonExclusiveSpaDiscountsDesc')}</p>
                      </div>
                    </div>
                    <div className="why-people-list-display-wrapper">
                      <div className="clearfix">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonVerifiedReviewsText')}</h4>
                        <p>{t('comingSoonVerifiedReviewsDesc')}</p>
                      </div>
                    </div>
                    <div className="why-people-list-display-wrapper">
                      <div className="clearfix">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonRewardsPointsText')}</h4>
                        <p>{t('comingSoonRewardsPointsDesc')}</p>
                      </div>
                    </div>
                    <div className="why-people-list-display-wrapper">
                      <div className="clearfix">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonNoHiddenFeesText')}</h4>
                        <p>{t('comingSoonNoHiddenFeesDesc')}</p>
                      </div>
                    </div>
                    <div className="why-people-list-display-wrapper">
                      <div className="clearfix">
                      ...
                      <div className="why-list-detail-div">
                        <h4>{t('comingSoonSameDayAppointmentsText')}</h4>
                        <p>{t('comingSoonSameDayAppointmentsDesc')}</p>
                      </div>
                    </div>
                  </div>
                </Col>
          ...
          <div className="spas-block-wrapper">
            <div className="spa-title-arrow-div">
              <h4 className="spas-name-title-text">
                ...
                {t('comingSoonFeaturedSpasNearYouText')}
              </h4>
                                  ...
                                  <ScottsdaleBoxWrapper className="box-wrapperdiv sitback-updated-slide-box-wrapper">
                                    ...
                                    <div className="scottsdale-detail">
                                      ...
                                      <div className="checkbox-and-btn">
                                        ...
                                        <Button className="book-now-btn" onClick={() => { handleRadioChangeWithService(spa)}}>{t('bookNow')}</Button>
                                      </div>
                                    </div>
                                  </ScottsdaleBoxWrapper>
                                </SwiperSlide>
          ...
          <div className="faq-inner-div">
            ...
            {loadingFaq ? (
              ...
              <div className="faq-loading-skeleton">
                {[1, 2, 3, 4, 5].map((item) => (
                  <div key={item} className="faq-skeleton-item">
                    <Skeleton height={60} />
                  </div>
                ))}
              </div>
            ) : (
              // Only show FAQs section if there are FAQs
              faqData && faqData.length > 0 && (
                <>
                  ...
                  {/* Only show View All button if there are more than 5 FAQs */}
                  {faqData.length > 5 && (
                    <Button className="faq-button-wrapper" onClick={() => { push(PATH_AUTH?.faqs) }}>View All FAQs</Button>
                  )}
                </>
              )
            )}
